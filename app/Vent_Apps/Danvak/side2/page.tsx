...
const tableData = {
  X_Num: [0, 0.1, 0.17, 0.25, 0.5], // A1/A2 værdier (kolonner)
  Y_Num: [10,15,20,30,45,60,90,120,150,180], // alpha værdier (rækker)
  values: [
    [0, 0.05, 0.05, 0.05, 0.05],   // alpha = 10
    [0, 0.05, 0.04, 0.04, 0.05],   // alpha = 15
    [0, 0.05, 0.04, 0.04, 0.05],   // alpha = 20
    [0, 0.05, 0.04, 0.04, 0.05],   // alpha = 30
    [0, 0.07, 0.06, 0.06, 0.06],   // alpha = 45
    [0, 0.08, 0.07, 0.07, 0.05],   // alpha = 60
    [0, 0.19, 0.18, 0.17, 0.12],   // alpha = 90
    [0, 0.29, 0.28, 0.27, 0.18],   // alpha = 120
    [0, 0.37, 0.36, 0.35, 0.24],   // alpha = 150
    [0, 0.43, 0.42, 0.41, 0.26],   // alpha = 180
  ],
};
...
type InputRef = {
  ...
  const getRefs = (): InputRef[] => {
    if (selectedShape === 'square') {
      return [
        ...
        { ref: højde2Ref, index: 2 },
        { ref: bredde2Ref, index: 3 },
        { ref: højde1Ref, index: 4 },
        { ref: bredde1Ref, index: 5 },
  ...
  const handelBeregner = () => {
    if (selectedShape === 'square') {
      ...
      const A1OA2 = areal1/areal2; // A1/A2
        ...
        <div className={styles.container}>
          ...
          <div className={styles.inputGroup}>
            ...
            {selectedShape === 'square' ? (
              <>
                 <div className={styles.inputField}>
                  <label htmlFor="højde2">Højde2 [mm]: </label>
                  <input
                    id="højde2"
                    type="number"
                    value={højde2 ?? ''}
                ...
                <div className={styles.inputField}>
                  <label htmlFor="bredde2">Bredde2 [mm]: </label>
                  <input
                    id="bredde2"
                    type="number"
                    value={bredde2 ?? ''}
                ...
                <div className={styles.inputField}>
                  <label htmlFor="højde1">Højde1 [mm]: </label>
                  <input
                    id="højde1"
                    type="number"
                    value={højde1 ?? ''}
                ...
                <div className={styles.inputField}>
                  <label htmlFor="bredde1">Bredde1 [mm]: </label>
                  <input
                    id="bredde1"
                    type="number"
                    value={bredde1 ?? ''}
